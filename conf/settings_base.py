...
try:
    ATECH_PARTS_UPSERT_MAX_WORKERS = int(os.environ.get("ATECH_PARTS_UPSERT_MAX_WORKERS", "4"))
except ValueError:
    ATECH_PARTS_UPSERT_MAX_WORKERS = 4
try:
    ATECH_COMPANY_PRICING_UPSERT_MAX_WORKERS = int(os.environ.get("ATECH_COMPANY_PRICING_UPSERT_MAX_WORKERS", "4"))
except ValueError:
