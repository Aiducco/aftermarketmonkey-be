    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            audit_scheduled_tasks.mark_scheduled_task_completed(
                execution,
                message='Successfully completed Turn 14 all brand pricing fetch.',
            )
            self.stdout.write(self.style.SUCCESS('Successfully completed Turn 14 all brand pricing fetch.'))
